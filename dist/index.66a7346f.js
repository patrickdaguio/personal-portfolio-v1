...
var _baffle = require("baffle");
var _baffleDefault = parcelHelpers.interopDefault(_baffle);
...
window.addEventListener('scroll', function() {
    ...
    if (scrollTop > lastScrollTop) header.classList.add('header-scroll');
    ...
    sections.forEach((section)=>{
        ...
        if (scrollY >= sectionTop - 550) current = section.getAttribute('id');
    });
    navbarLinks.forEach((link)=>{
        link.classList.remove('header__nav__list__link--active');
        if (link.classList.contains(current)) link.classList.add('header__nav__list__link--active');
    });
});
// Theme Changer
...
// Heading Animation
const heading = _baffleDefault.default('.hero__caption');
heading.set({
    characters: '▒<▓ ▓█//< ▓>▒▒/ ▒>▒ ▓▒░█▒ ▒▒▒█ █░█ ░▓░/ ▓▒▓█',
    speed: 50
});
heading.start();
setTimeout(()=>heading.reveal(4000)
, 4300);
// Logo Animation
const logoPaths = document.querySelectorAll('.logo path');
const tlHome = _gsap.gsap.timeline({
    defaults: {
        duration: 0.5,
        ease: 'power4.easeInAndOut'
    }
});
tlHome.to(logoPaths[0], {
    duration: 2,
    strokeDashoffset: 0
}).to(logoPaths[1], {
    duration: 2,
    ...
    overflowY: 'auto'
}, 2.6).from('.header__logo', {
    scale: 0
}, 2.4).to('.container', {
    opacity: 1,
    visibility: 'visible',
    zIndex: '5'
}, 2.7).from('.header__nav__list__item', {
    opacity: 0,
    translateY: '-25px',
    stagger: 0.2
}, 2.9).from('#particles-js', {
    opacity: 0
}, 3.9).from([
    '.hero__intro',
    '.hero__name',
...
let tlAbout = _gsap.gsap.timeline({
    scrollTrigger: {
        trigger: '.about',
        start: 'top 100%'
    }
});
tlAbout.from('.about__heading', {
    opacity: 0
}).from('.about__tools__heading', {
    opacity: 0
}, '-=0.3').from('.about__details', {
    opacity: 0
}, 0.3).from('.about__tools__tool', {
    opacity: 0,
    stagger: 0.1
}, 0);
const portfolioProject = document.querySelectorAll('.portfolio__project');
_gsap.gsap.from('.portfolio', {
    scrollTrigger: {
        trigger: '.about',
        start: 'bottom center'
    },
...
_gsap.gsap.from(portfolioProject[0], {
    scrollTrigger: {
...
_gsap.gsap.from(portfolioProject[1], {
    scrollTrigger: {
...
_gsap.gsap.from(portfolioProject[2], {
    scrollTrigger: {
...
_gsap.gsap.from(portfolioProject[3], {
    scrollTrigger: {
...
let tlContact = _gsap.gsap.timeline({
    scrollTrigger: {
        trigger: '.contact',
        start: '25% 75%'
    }
});
tlContact.from('.contact__message-wrapper', {
    opacity: 0
...
const landingPageProjects = document.querySelectorAll('.portfolio__project__choices__choice');
const landingPageImage = document.querySelectorAll('.portfolio__project__image');
const landingPageLink = document.querySelector('.portfolio__project__link--link');
...
function generateUniqueRandom(maxNr) {
    ...
    if (!uniqueNumbersArray.includes(random)) {
        ...
        if (uniqueNumbersArray.length < maxNr.length) //Recursively generate number
...
function greetingsGenerator() {
    ...
    const adjective = _baffleDefault.default('.contact__adjective');
    adjective.set({
        characters: '▒<▓ ▓█//< ▓>▒▒/ ▒>▒ ▓▒░█▒ ▒▒▒█ █░█ ░▓░/ ▓▒▓█',
        speed: 100
    });
...
// Hamburger Menu
const tlMobile = _gsap.gsap.timeline({
    defaults: {
        duration: 0.3,
        ease: 'power4.easeInAndOut',
        onComplete: function() {
...
let playing = false;
tlMobile.from('.header__menu__list__item', {
    opacity: 0,
    translateX: '250px',
    stagger: 0.1
}).from('.header__menu__socials__item', {
    translateY: '250px',
    stagger: 0.1
}, 0.1);
...
const validateNameInput = ()=>{
    ...
    if (!contactName.value) contactName.nextElementSibling.textContent = 'PLEASE ENTER YOUR NAME';
    else if (!contactEmail.value || !isValidEmail(contactEmail.value)) contactEmail.nextElementSibling.textContent = 'PLEASE ENTER A VALID EMAIL';
    else if (!contactMsg.value) contactMsg.nextElementSibling.textContent = 'PLEASE ENTER A MESSAGE';
    else isFormValid = true;
};
inputElms.forEach((elms)=>elms.addEventListener('input', validateNameInput)
);
let tlResponse = _gsap.gsap.timeline({
    defaults: {
        duration: 1,
        ease: 'power4.easeInAndOut'
    }
...
contactForm.addEventListener('submit', (e)=>{
    ...
    validateNameInput();
    if (isFormValid) {
        tlResponse = _gsap.gsap.timeline({
            defaults: {
                duration: 1,
                ease: 'power4.easeInAndOut'
            }
        });
        tlResponse.to('.contact__response', {
            autoAlpha: 1,
            display: 'block',
            x: 0
...
async function handleSubmit(event) {
    ...
    fetch(event.target.action, {
        ...
        resText.textContent = 'Your message has been sent. Will get back to you as soon as possible';
        inputElms.forEach((elms)=>elms.value = ''
        );
    }).catch((error)=>{
        resHeading.textContent = 'Oops!';
        resText.textContent = 'An error has occurred and your message has not been sent successfully. Please try again in a few minutes.';
    });
}

},{"gsap":"2aTR0","gsap/ScrollTrigger":"41HI5","baffle":"iXcFP","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"2aTR0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./gsap-core.js":"dbpJR","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"41HI5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ScrollTrigger", ()=>ScrollTrigger1
);
parcelHelpers.export(exports, "default", ()=>ScrollTrigger1
);
/*!
 * ScrollTrigger 3.8.0
 * https://greensock.com
...
}, _softRefresh1 = function _softRefresh() {
    return _removeListener(ScrollTrigger1, "scrollEnd", _softRefresh) || _refreshAll(true);
...
_refreshingAll, _refreshAll = function _refreshAll(force, skipRevert) {
    if (_lastScrollTime && !force) {
        _addListener(ScrollTrigger1, "scrollEnd", _softRefresh1);
        return;
    }
    _refreshingAll = true;
    var refreshInits = _dispatch("refreshInit");
    _sort && ScrollTrigger1.sort();
...
var ScrollTrigger1 = /*#__PURE__*/ function() {
    ...
    _proto.init = function init(vars, animation) {
        ...
        self.refresh = function(soft, force) {
            ...
            if (pin && soft && _lastScrollTime) {
                _addListener(ScrollTrigger, "scrollEnd", _softRefresh1);
                return;
            }
            _refreshing = 1;
...
ScrollTrigger1.version = "3.8.0";
ScrollTrigger1.saveStyles = function(targets) {
...
ScrollTrigger1.revert = function(soft, media) {
    return _revertAll(!soft, media);
};
ScrollTrigger1.create = function(vars, animation) {
    return new ScrollTrigger1(vars, animation);
};
ScrollTrigger1.refresh = function(safe) {
    return safe ? _onResize() : (_coreInitted || ScrollTrigger1.register()) && _refreshAll(true);
};
ScrollTrigger1.update = _updateAll;
ScrollTrigger1.clearScrollMemory = _clearScrollMemory;
ScrollTrigger1.maxScroll = function(element, horizontal) {
    return _maxScroll(element, horizontal ? _horizontal : _vertical);
};
ScrollTrigger1.getScrollFunc = function(element, horizontal) {
    return _getScrollFunc(_getTarget(element), horizontal ? _horizontal : _vertical);
};
ScrollTrigger1.getById = function(id) {
    return _ids[id];
};
ScrollTrigger1.getAll = function() {
    return _triggers.slice(0);
};
ScrollTrigger1.isScrolling = function() {
    return !!_lastScrollTime;
};
ScrollTrigger1.snapDirectional = _snapDirectional;
ScrollTrigger1.addEventListener = function(type, callback) {
    var a = _listeners[type] || (_listeners[type] = []);
    ~a.indexOf(callback) || a.push(callback);
};
ScrollTrigger1.removeEventListener = function(type, callback) {
    var a = _listeners[type], i = a && a.indexOf(callback);
    i >= 0 && a.splice(i, 1);
};
ScrollTrigger1.batch = function(targets, vars) {
    var result = [], varsCopy = {
    ...
    if (_isFunction(batchMax)) {
        batchMax = batchMax();
        _addListener(ScrollTrigger1, "refresh", function() {
    ...
    _toArray(targets).forEach(function(target) {
        ...
        result.push(ScrollTrigger1.create(config));
    });
    return result;
};
ScrollTrigger1.sort = function(func) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"iXcFP":[function(require,module,exports) {
/*!
    ...
    return (function(t) {
        ...
        function(t2, e1) {
            ...
            Object.defineProperty(e1, "__esModule", {
                value: !0
            }), e1.extend = n1, e1.mapString = r1, e1.sample = i, e1.each = o, e1.getTruthyIndices = u, e1.getElements = s;
        },
        function(t4, e2, n2) {
            "use strict";
            function r2(t) {
            ...
            var o = n2(1), u = n2(3), s = r2(u), c = {
                ...
                function t5(e, n) {
                    i1(this, t5), this.options = (0, o.extend)(Object.create(c), n), this.elements = (0, o.getElements)(e).map(s["default"]), this.running = !1;
                }
                return t5.prototype.once = function() {
                    var t = this;
                ...
                }, t5.prototype.set = function(t) {
                    return (0, o.extend)(this.options, t), this.running && this.start(), this;
                }, t5.prototype.text = function(t) {
                    var e = this;
                    return (0, o.each)(this.elements, function(n) {
                        n.text(t(n.value)), e.running || n.write();
                    }), this;
                }, t5.prototype.reveal = function() {
                    var t7 = this, e3 = arguments.length <= 0 || void 0 === arguments[0] ? 0 : arguments[0], n3 = arguments.length <= 1 || void 0 === arguments[1] ? 0 : arguments[1], r = e3 / this.options.speed || 1, i = function() {
                        clearInterval(t7.interval), t7.running = !0, t7.interval = setInterval(function() {
                            var e4 = t7.elements.filter(function(t8) {
                                return !t8.bitmap.every(function(t) {
                                    return !t;
                                });
                            });
                            (0, o.each)(e4, function(e) {
                                var n = Math.ceil(e.value.length / r);
                                e.decay(n).write(t7.options.characters, t7.options.exclude);
                            }), e4.length || (t7.stop(), (0, o.each)(t7.elements, function(t) {
                                return t.init();
                            }));
                        }, t7.options.speed);
                    };
                    return setTimeout(i, n3), this;
                }, t5;
            }();
            e2["default"] = function(t, e) {
                return new a(t, e);
            };
        },
        function(t9, e5, n4) {
            ...
            var u = n4(1), s = function() {
                function t10(e) {
                    o(this, t10), this.value = e, this.init();
                }
                return t10.prototype.init = function() {
                    return this.bitmap = this.value.split("").map(function() {
                        return 1;
                    }), this;
                }, t10.prototype.render = function() {
                ...
                function e6(n) {
                    o(this, e6);
                    var i = r3(this, t11.call(this, n.textContent));
                    return i.element = n, i;
                }
                return i2(e6, t11), e6.prototype.write = function(t, e) {
                    return this.element.textContent = this.render(t, e), this;
                }, e6;
            }(s);
            e5["default"] = function(t) {
                return new c(t);
            };
        }
    ]);
...
},{}]},["grPCQ","cdtrO"], "cdtrO", "parcelRequire7c7c")
